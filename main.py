...
# TODO:
# - Restructure to make code adhere to MVC better - in progress
# - DONE: Rename variables, functions for clarity and consistency 
...
# - DONE:New class for drawing box - hopefully this will solve cursor offset issues
